...
class BeatSyncProcessor(Processor):
    ...
    def process_online(self, data, **kwargs):
        ...
        if self.last_beat_time is None:
            ...
            # return an empty beat, since the beat_feat is not synchronised yet
...
class DBNBarTrackingProcessor(Processor):
    ...
    def infer_online(self, beat, activation, **kwargs):
    ...
    def infer_offline(self, beats, activations, **kwargs):
    ...
    def process(self, data, **kwargs):
        ...
        if self.online:
            return self.infer_online(*data, **kwargs)
        else:
            # get the best state path by calling the viterbi algorithm
            return self.infer_offline(*data, **kwargs)
